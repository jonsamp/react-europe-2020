...
export function Step4() {
  ...
  // TODO: Create a fuction that will open the image picker asynchronously when the button is pressed.
  // This image picker should:
  //  - Get a permission result from ImagePicker.requestCameraRollPermissionsAsync
  //  - If that premissionResult.granted === false, then stop.
